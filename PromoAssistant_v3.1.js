...
var telesalesArray = ["Inside Sales"];
var salesChatArray = ["Sales Chat"];
var smbArray = ["SMB"];
...
var careArray = ["Wireless Care","B2B","Dfill","Sales Chat"];
...
for(i = 0; i < promosArray.length;i++) {
    ...
    for (var j in channels) {
        ...
        if ($.inArray(channels[j],salesChatArray) != -1)
        {
...
colModel.push({label: "Promotion/OST Link",name:"project", width: 185, formatter:formatname,align: "left", sortable:true});
